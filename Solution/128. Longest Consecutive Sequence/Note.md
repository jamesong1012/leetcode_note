...
---
### 2025/05/31
Using __unordered_set(hash)__ to find the LCS.  
...
Remove the number is the table once it's checked to __avoid from double checking__ until all the elements in the table have been checked.
#### Complexity Analysis
